...
This app simulates that scenario with fictional bonds. You can edit the bond values, simulate a lottery draw, and analyze outcomes.
""")
...
st.markdown("""
### Strategy Discussion
- Which bonds offer the best value?
